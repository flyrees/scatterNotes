...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '86594cb21e01423d8e333d111a0a90b4,en:86594cb21e01423d8e333d111a0a90b4',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '散记', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '随时随地记录你的灵感和想法😊', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.flyreesnotes.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '记录, 灵感, 想法', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'flyrees@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '随时随地记录你的想法和灵感', // 站点描述，被notion中的页面描述覆盖
